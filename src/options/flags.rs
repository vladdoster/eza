...
pub static CLASSIFY: Arg = Arg {
    short: Some(b'F'),
    long: "classify",
    takes_value: TakesValue::Optional(Some(WHEN), "auto"),
};
...
pub static COLOR_SCALE: Arg = Arg {
    short: None,
    long: "color-scale",
    takes_value: TakesValue::Optional(Some(SCALES), "all"),
};
